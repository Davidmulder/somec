                          ...
                          <tr>
                            <td><table width="675" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td align="left" class="ft_vd_tit_30"><strong>Projetos</strong></td>
                              </tr>
                            </table></td>
                          </tr>
			  ...
			  ?>
                          ...
                          <tr>
                            <td height="30" class="fd_tit"><table width="600" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="left"><span class="ft_vd_tit"><strong>Mais projetos</strong></span></td>
                              </tr>
                            </table></td>
                          </tr>
                          <tr>
             ...
             $totalRows_lista = mysql_num_rows($query);				
				...
				?>
						<?php do {?>  
                          ...
                          <tr>
                            <td align="left" valign="top" class="ft_pt_12">
							<a id="link" href="?id=<?php echo $row_lista["id"]; ?>" target="_parent" ><?php echo $row_lista["titulo"]; ?></a></td>
                          </tr>
                          <tr>
