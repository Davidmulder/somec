                          ...
                          <tr>
                            <td><table width="675" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td align="left" class="ft_vd_tit_30"><strong>Videos</strong></td>
                              </tr>
                            </table></td>
                          </tr>
                          <tr>
						...
						?>
                                ...
                                <td width="675" align="center"><table width="255" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
									...
									<a id="link" href="javascript:window.open('http://www.youtube.com/watch_popup?v=<?php echo $video; ?>&amp;vq=medium','Painel','resizable=no,toolbar=no,status=no,menubar=no,scrollbars=0,resizeable=no,width=660,height=520');void(0)">
									
								<img src="<?php echo $row_varea["foto"]; ?>" width="240" height="180" border="0"></a></td>
                                    </tr>
                                  <tr>
