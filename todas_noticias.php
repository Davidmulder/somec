                          ...
                          <tr>
                            <td><table width="675" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td align="left" class="ft_vd_tit_30"><strong>Mais Not&iacute;cias </strong></td>
                              </tr>
                            </table></td>
                          </tr>
                          <tr>
             ...
             $totalRows_varea = mysql_num_rows($query);
			  ...
			  ?>
					...
					?>
							...
							<a id="link" href="noticias.php?id=<?php echo $row_varea["id"]; ?>" target="_parent" ><?php echo $row_varea["titulo"]; ?></a>
